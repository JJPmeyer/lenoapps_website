...
export default function DataBridgeTerms(): React.ReactNode {
  return (
    <Layout
      title="Terms of Service - Leno Apps"
      description="Terms of Service for Data Bridge - Leno Apps"
    >
      <main className="container margin-vert--lg">
        <Heading as="h1">Terms of Service - Data Bridge</Heading>
        <p>
        ...
        <section>
          ...
          <p>
            By installing, accessing, or using the Data Bridge application
            ("App," "Service," "we," "us," or "our"), you ("User," "you," or
            "your") agree to be bound by these Terms of Service ("Terms"). If
        ...
        <section>
          ...
          <p>
            Data Bridge is a monday.com marketplace application that allows
            users to:
          </p>
          <ul>
            <li>Connect supported data sources and bring data into monday.com</li>
            <li>
              Create and save import templates, mappings, and schedules for
              repeat use
            </li>
            <li>Run one-time and scheduled imports</li>
            <li>
              Import data into standard boards and multi subitems boards within
              your monday account
            </li>
            <li>Track progress and review import results and errors</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              You can revoke monday app authorization at any time through
              monday.com's app management interface
            </li>
            <li>
              You can revoke external connector access, such as Google access,
              through the relevant provider account controls
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>me:read:</strong> To identify users and manage app context
            </li>
            <li>
              <strong>boards:read:</strong> To read board structure, target
              boards, groups, and item context for imports
            </li>
            <li>
              <strong>boards:write:</strong> To create or update data during
              import operations
            </li>
          </ul>
          ...
          <ul>
            <li>The App only accesses boards within your authorized account</li>
            <li>
              Data access is limited to functionality described in this
              agreement
            </li>
            <li>
              Connector access is limited to the source data you explicitly
              authorize
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              Billing changes and subscription cancellations are handled through
              monday.com's marketplace billing system
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>Import and synchronize business data into monday.com</li>
            <li>Create and manage import templates and schedules</li>
            <li>Use supported source connectors for business data you are
              authorized to use</li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Connect, upload, or import data you do not have rights to access
              or process
            </li>
        ...
        <section>
          ...
          <ul>
            <li>You retain ownership of your source data and imported content</li>
            <li>
              You grant us a limited license to process your data to provide the
              Service
            </li>
            <li>
              You are responsible for ensuring you have rights to any data you
              connect, upload, or import
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              All data is stored securely within monday.com's hosted
              infrastructure as required for the service
            </li>
            <li>
            ...
            <li>
              We do not use customer data for model training, profiling, or
              marketing
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Some parts of the service depend on third-party and platform
              services, including monday.com and Google
            </li>
          </ul>
